...
*Suggested Citation*: Nsiah, C., Sahni, H., and Fayissa, B. (2025). Nonlinearities in the Impact of Age Dependency on the Quality of Economic Growth (QGI) in Africa [Data set]. URL: [https://github.com/hermansahni/quality-econgrowth-data-repo](https://github.com/hermansahni/quality-econgrowth-data-repo)
